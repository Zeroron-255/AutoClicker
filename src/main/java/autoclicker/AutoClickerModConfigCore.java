...
public class AutoClickerModConfigCore {
  ...
  public static void syncConfig() {
    ...
    AutoClickerMod.fishingRodString = cfg.getString("fishingRodName", "General.AutoFishing", AutoClickerMod.fishingRodString, "Fishing rods that contain the characters you entered will be subject to automatic fishing. \nEnter object IDs separated by commas! \n");
